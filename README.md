This script can automatically download CSV file from online resource with https protocal, then convert this CSV file to JSON file, and put both files into same folder.
